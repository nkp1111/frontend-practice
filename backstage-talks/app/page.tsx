...
export default function Home() {
  ...
  return (
    <main className={`h-[100vh] p-5 flex flex-col bg- justify-between text-lg ${issueColors[currentView]} transition-all duration-300 ease-linear`}>
      <div className="flex-1 flex justify-between">
        <div className="flex-1">
          <h1 className={`uppercase font-boldtext-4xl ${inter.className}`}>backstage talks</h1>
        </div>
      ...
      <div className="flex-1 flex justify-between items-end">
        <div className="flex-1">
          ...
          <p className="text-sm mb-5 mt-1 text-gray-600">&copy; 2024
